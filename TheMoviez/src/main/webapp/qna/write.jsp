...
<head>
<meta charset="UTF-8">
<title>The Moviez : Q&A - Write</title>
</head>
<body onload="document.qna.qna_title.focus();">
	...
	<br>
	<form action="write.do" id="qna" name="qna" method="post" accept-charset="UTF-8">
		...
		<table class="board" border="0">
			...
			<tr>
				...
				<td><input type="text" id="qna_title" name="qna_title" class="box1 board-box board-input"></td>
			</tr>
			<tr>
				<td class="board-right">내용</td>
				<td><textarea id="qna_content" name="qna_content" class="box1 board-input"></textarea></td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
