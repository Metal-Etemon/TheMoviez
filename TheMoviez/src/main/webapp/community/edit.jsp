...
<head>
<meta charset="UTF-8">
<title>The Moviez : Community - Edit</title>
</head>
		...
		<div class="container-content">
			...
			<form action="edit.do" id="community" name="community" method="post"
				...
				<table class="board" border="0">
					...
					<tr>
						...
						<td><input type="text" id="com_title" name="com_title"
							class="box1 board-box board-input" value="${content.com_title}"></td>
					</tr>
					<tr>
						<td class="board-right">내용</td>
						<td><textarea id="com_content" name="com_content"
								class="box1 board-input">${content.com_content}</textarea></td>
					</tr>
					<tr>
						<td><br></td>
					</tr>
				...
				<div class="div-center">
					<input type="button" value="수정" onclick="comWrite_ck()"
